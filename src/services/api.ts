...
export const roomAPI = {
  ...
  async sendStartVideoToUE(modelId:string, clothId: string, roomId: string, beautyPic: string,videoPathCloth: string, access_token: string,actionPath:string,actionPathBack:string,beginImgId:string,bgm:string): Promise<ApiResponse> {
    // if(isRecLog) 
